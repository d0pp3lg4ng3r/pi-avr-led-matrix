...
update:										;callback for overflow of TCNT0
	...
	set		YH			high(bytebuff)		;load the high byte of the address into the pointer
...
i2c_was_us:
	...
	adiw	ZH			READ_POS			;offset the read location start
...
skip_check_addr:
	...
	cmp		READ_POS	0					;check if out of bytes we can store
